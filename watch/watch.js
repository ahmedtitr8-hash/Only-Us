...
// جافاسكربت (منها currentVideoState) تنمسح، والمشغل يبين فاضي لين الطرف الثاني يرسل
// الفيديو من جديد عبر رسالة hello — وهذا اللي يحس المستخدم معه إنه "دخل غرفة ثانية فاضية"
// مع إن رمز الغرفة نفسه ما تغيّر أصلًا. بإعادة تحميل الفيديو محليًا فورًا من فايربيس، المشغل
// يرجع مباشرة لنفس الشخص اللي حدّث صفحته، بدون ما ينتظر الطرف الثاني ولا يعتمد على أي
// شيء محفوظ بالمتصفح نفسه.
