...
// لوحة رابط الفيديو صارت ظاهرة دائمًا (شوف watch.html)، فهذه الدالة الحين بس تركّز
// على حقل الإدخال بدل ما تظهر/تخفي اللوحة
function focusVideoUrlPanel() {
  videoUrlInput.focus();
}

changeVideoBtn.addEventListener('click', focusVideoUrlPanel);
if (addVideoBtn) addVideoBtn.addEventListener('click', focusVideoUrlPanel);
