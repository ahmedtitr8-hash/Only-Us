  ...
  dataConn.on('data', (msg) => {
    switch (msg.kind) {
      ...
      case 'mic-state':
        ...
        break;
      // ملاحظة: الشات ومؤشر "يكتب الآن" انتقلوا بالكامل لـFirestore (شوف
      // setupFirestoreChatSync أسفل) - ما عادوا يمرون من هنا إطلاقًا.
...
function setupFirestoreChatSync(code) {
  ...
  // استماع لحقل "يكتب الآن" على مستند الغرفة نفسه (بدل رسائل typing/typing-stop عبر sendData)
